...
multiqc:
1. ![Перед тримом](Images/Аналитика1_1.png "Перед тримом")
2. ![Перед тримом](Images/Аналитика1_2.png "Перед тримом")
3. ![Перед тримом](Images/Аналитика1_3.png "Перед тримом")

multiqc trimmed:
1. ![После трима](Images/Аналитика2_1.png "После трима")
2. ![После трима](Images/Аналитика2_2.png "После трима")
3. ![После трима](Images/Аналитика2_3.png "После трима")
